...
def off_eng(btn_eng_objs, btn_manage_objs, btn_eng, master, *args):
    ...
    btn_manage_objs[0].grid(row=2, column=2, columnspan=3, sticky='news', pady=(3,1), padx=3)
    btn_manage_objs[1].grid(row=3, column=2, columnspan=3, sticky='news', pady=(1,3), padx=3)
    btn_manage_objs[2].grid(row=2, column=5, rowspan=2, sticky='news', pady=2, padx=3)
    btn_manage_objs[3].grid(row=2, column=1, rowspan=2, sticky='news', pady=2, padx=3)

    btn_eng.configure(command=on_eng)
    master.bind('e', on_eng)
...
def on_eng(btn_eng_objs, btn_manage_objs, btn_eng, master, *args):
    ...
    for i, btn_eng_obj in enumerate(btn_eng_objs):
        ...
        if i >=5:
            btn_eng_obj.grid(row=(i//10)+5, column=(i%5)+1, sticky='news', pady=3, padx=3)
        else:
            btn_eng_obj.grid(row=(i%5)+5, column=0, sticky='news', pady=3, padx=3)
    
    btn_manage_objs[0].grid(row=3, column=2, columnspan=2, sticky='news', pady=(1,3), padx=3)
    btn_manage_objs[1].grid(row=2, column=2, columnspan=2, sticky='news', pady=(3,1), padx=3)
    btn_manage_objs[2].grid(row=2, column=4, rowspan=2, columnspan=2, sticky='news', pady=3, padx=3)
    btn_manage_objs[3].grid(row=2, column=0, rowspan=2, columnspan=2, sticky='news', pady=3, padx=3)
 
    btn_eng.configure(command=off_eng)
    master.bind('e', off_eng)